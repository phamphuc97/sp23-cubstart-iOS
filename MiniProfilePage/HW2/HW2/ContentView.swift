...
struct ContentView: View {
    var body: some View {
        ...
        let newFacts = [
            Fact(
                id: UUID(), description: "Spinachs make you grow stronger.", image: "spinach"),
            
            Fact(
                id: UUID(), description: "If you wake up in the morning and get a back pain, wake up in the afternoon instead.", image: "backpain"),
            
            Fact(
                id: UUID(), description: "Did you know? The water is wet.", image: "water"),
            
            Fact(
                id: UUID(), description: "For every 60 seconds in Africa, a minute passes.", image: "africa_map"),
            
            Fact(
                id: UUID(), description: "The grass is green.", image: "grass")
...
//5. TODO: instantiate an instance of the Person class, passing in the necessary parameters. replace the string below.
        let my_name = Person(name: "Frederick", grade: "Senior", img: "Popeye", age: "26", hometown: "San Jose")
